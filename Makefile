...
INSTALL_TNAME= zator-$(VERSION)
INSTALL_TSYMNAME= zator
...
default all $(INSTALL_DEP):
	@echo "==== Building Zator $(MMVERSION) ===="
	$(MAKE) -C src
	@echo "==== Successfully built Zator $(MMVERSION) ===="

install: $(INSTALL_DEP)
	@echo "==== Installing Zator $(VERSION) to $(PREFIX) ===="
	$(MKDIR) $(INSTALL_DIRS)
	...
	@echo "==== Successfully installed Zator $(VERSION) to $(PREFIX) ===="

uninstall:
	@echo "==== Uninstalling Zator $(VERSION) from $(PREFIX) ===="
	...
	@echo "==== Successfully uninstalled Zator $(VERSION) from $(PREFIX) ===="

##############################################################################

amalg:
	@echo "==== Building Zator $(MMVERSION) (amalgamation) ===="
	$(MAKE) -C src amalg
	@echo "==== Successfully built Zator $(MMVERSION) (amalgamation) ===="
